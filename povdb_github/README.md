...
- **Full POVDB library** (737,519 records, ~600 MB MSP): available on
  reasonable request from the corresponding authors:
  - Nanyang Yu — yuny@nju.edu.cn
  - Si Wei — weisi@nju.edu.cn
- **Training data** and the **sample library** are committed in `data/`.
...
For questions, bug reports, or access to the full POVDB library, please
contact the corresponding authors:

- Nanyang Yu (yuny@nju.edu.cn)
- Si Wei (weisi@nju.edu.cn)

If you use this code or the POVDB in your work, please cite:

> Wang et al., *Embedding an Olfactory Data Hub in Smart Cities for Odor-Free
> Urban Management*, Science Advances (2026).
